...
raw_sp_data <- read.csv("https://raw.githubusercontent.com/hertzPSF/COSEWIC-compilation/main/Output/CU_Spawner_Abund_20250925+Yukon.csv", 
                        header=TRUE) |>
  filter(Spawner.Abundance>0)|>
...
cu_metadata <- read.csv("https://raw.githubusercontent.com/hertzPSF/COSEWIC-compilation/main/Output/CU_Metadata_20241114.csv",  
...
designations <- rbind(assessed,not_assessed)|>
  ...
  filter(region_full != "Transboundary")
...
max_facets <- 15 #how many facets (i.e. panes) per plot?
rows <- 5 #how many rows/cols? note needs to be multiple of facets. 
cols <- 3
