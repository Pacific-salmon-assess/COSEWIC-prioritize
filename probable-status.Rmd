...
# read in data ----
raw_sp_data <- read.csv("./data/CU_Spawner_Abund_20220804.csv", 
                        header=TRUE) %>%
  mutate(logSp=log(Spawner.Abundance))

cu_metadata <- read.csv("./data/CU_Metadata_20220804.csv",  
...
#^ NOTE! this is where we lose some of the region info. dus are getting merged from 
  #cu_metadata to prob_desg that don't have and region data!
